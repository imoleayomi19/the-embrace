                ...
                {[
                  ...
                  <div key={idx} className="flex gap-6">
                    <div className="flex flex-col items-center">
                      <div className={`w-12 h-12 rounded-full font-anton text-xl flex items-center justify-center shrink-0 z-10 ${idx % 2 === 0 ? 'bg-alternativeO text-white' : 'bg-alternativeR text-white'}`}>
                        {step.num}
                      </div>
                      {idx !== 3 && (
