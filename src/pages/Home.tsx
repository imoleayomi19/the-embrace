...
//               <h2 className="font-poppins font-bold text-4xl md:text-5xl lg:text-6xl text-primary leading-tight mb-6">
...
//                   <div className="font-anton text-alternativeO text-5xl md:text-6xl mb-4 leading-none">01</div>
//                   <h3 className="font-poppins font-bold text-primary text-lg mb-2">Certified Installers</h3>
...
//                 <motion.div variants={fadeIn} className="bg-white rounded-2xl p-6 md:p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300">
//                   <div className="font-anton text-alternativeR text-5xl md:text-6xl mb-4 leading-none">03</div>
//                   <h3 className="font-poppins font-bold text-primary text-lg mb-2">Lifetime Support</h3>
//                   <p className="text-primary/70 font-montserrat text-sm leading-relaxed">
...
//               >
//                 <motion.div variants={fadeIn} className="bg-white rounded-2xl p-6 md:p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300">
//                   <div className="font-anton text-secondary text-5xl md:text-6xl mb-4 leading-none">02</div>
//                   <h3 className="font-poppins font-bold text-primary text-lg mb-2">Premium Panels</h3>
//                   <p className="text-primary/70 font-montserrat text-sm leading-relaxed">
...
//                 <motion.div variants={fadeIn} className="bg-white rounded-2xl p-6 md:p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300">
//                   <div className="font-anton text-alternative text-5xl md:text-6xl mb-4 leading-none">04</div>
//                   <h3 className="font-poppins font-bold text-primary text-lg mb-2">Eco-Friendly</h3>
//                   <p className="text-primary/70 font-montserrat text-sm leading-relaxed">
...
//             <div className="space-y-3 text-slate-600 font-montserrat text-sm md:text-base leading-relaxed">
//               <p>
...
//               >
//                 {/* Title - At the top */}
//                 <h3 className="text-xl md:text-2xl font-poppins font-bold text-white mb-6 text-center">
//                   {service.title}
//                 </h3>
...
//                 <Link
//                   to="/services"
//                   className="inline-flex items-center justify-center w-full bg-white/10 hover:bg-secondary hover:text-primary text-white font-poppins font-semibold py-3 px-6 rounded-lg transition-all duration-300 group-hover:shadow-lg"
//                 >
//                   MORE DETAILS
...
//                         }}
//                       >
//                         <span className={`font-anton text-xs ${item.textColor}`}>
//                           {item.step}
//                         </span>
//                       </motion.div>
//                     </div>
...
//                     {/* Content */}
//                     <motion.h3
//                       className="text-xl font-poppins font-bold text-primary mb-3 group-hover:text-secondary transition-colors duration-300"
//                       initial={{ opacity: 0 }}
//                       whileInView={{ opacity: 1 }}
//                       viewport={{ once: true }}
...
//                   viewport={{ once: true }}
//                   transition={{ duration: 0.6 }}
//                   className="text-2xl md:text-3xl font-poppins font-bold text-white mb-6 text-center"
//                 >
...
//                           >
//                             <h4 className="text-white font-poppins font-semibold text-base md:text-lg mb-1">
//                               {testimonial.name}
//                             </h4>
            ...
            <div className="relative z-10 px-8 md:px-16 lg:px-24 py-12 md:py-16">
              <div className="max-w-5xl mx-auto">
                ...
                >
                  <div className="pr-4">
                    <motion.h2
                      className="text-3xl md:text-4xl lg:text-5xl font-poppins font-bold text-white mb-6 leading-tight"
                      initial={{ opacity: 0, y: 20 }}
                      whileInView={{ opacity: 1, y: 0 }}
                      viewport={{ once: true }}
                      transition={{ duration: 0.6 }}
                ...
                >
                  <Link
                    to="/services"
                    className="inline-flex items-center gap-3 bg-white text-primary font-bold font-poppins px-8 py-4 rounded-full hover:bg-secondary transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 group"
                  >
                    View All Services
